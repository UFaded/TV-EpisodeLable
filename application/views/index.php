    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 title">
                <h4>WELCOME TO</h4>
                <h2>TV EPISODE LABLE</h2>
                <hr>
                <p>剧集日历是一个查看影视信息的便捷通道。<br />为国内欧美影视剧爱好者提供一个高效的影视剧信息获取方式,<br />同时向用户提供简洁的欧美影视剧检索,追剧进度。</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8">
                <div class="col-md-6 col-sm-6 bg-black"> <a href=""><i class="fa fa-mobile"></i></a>
                    <h3>本月</h3>
                </div>
                <div class="col-md-6 col-sm-6 bg-red"> <a href=""><i class="fa fa-cloud"></i></a>
                    <h3>查找剧集</h3>
                </div>
                <div class="col-md-6 col-sm-6 bg-red"> <a href=""><i class="fa fa-link"></i></a>
                    <h3>当前热播</h3>
                </div>
                <div class="col-md-6 col-sm-6 bg-black"><a href=""><i class="fa fa-globe"></i></a>
                    <h3>个人中心</h3>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 copyright">
                <p>Copyright © 2018 Company Name | More Templates </p>
            </div>
        </div>
    </div>
</footer>
