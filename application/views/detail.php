          ...
          <nav class="navbar navbar-default scrollMenu" role="navigation" style="margin-bottom: 0px; ">
            ...
            <div class="collapse navbar-collapse" id="mainMenu">
              ...
              <ul class="nav navbar-nav pull-right">
                ...
                <!--本月观看-->
                <li class="primary">
                  <a href="/index.php/News/detail" class="firstLevel hasSubMenu active">本月观看</a>
                </li>
                <li class="sep"></li>
		      ...
		      <div class="col-md-12 text-left">
		        <div class="row">
		          <div class="col-md-7" id="day">        
		            <h1 id="da" value="26"><?php echo $d.'th '.$m;?></h1>
		            <p class="page-subtitle">Showing all posts with category <i>Computer</i></p>
		          </div>
		          <div class="col-md-5 text-center" style="line-height: 100px;">
		          	<a class="btn btn-default btn-rounded" href="/index.php/News/detail/<?php if(isset($dateStart)){ echo date('Y-m-d',strtotime("$dateStart -1 month"));} ?>" role="button">上&nbsp;&nbsp;月</a>
		          	<a class="btn btn-default btn-rounded" href="/index.php/News/detail/<?php if(isset($dateStart)){ echo date('Y-m-d',strtotime("$dateStart -1 day"));} ?>" role="button">上一天</a>
		          	<a class="btn btn-default btn-rounded" href="/index.php/News/detail/<?php if(isset($dateStart)){ echo date('Y-m-d',strtotime("$dateStart +1 day"));} ?>" role="button">下一天</a>
		          	<a class="btn btn-default btn-rounded" href="/index.php/News/detail/<?php if(isset($dateStart)){ echo date('Y-m-d',strtotime("$dateStart +1 month"));} ?>" role="button">下&nbsp;&nbsp;月</a>
		          </div>
		        </div>
		        <div class="line"></div>
		        <div class="row">
		            ...
		            <div class="inner">
		              ...
		              <div class="details">
		                <div class="detail">
		                  ...
		                  <!-- 日期需设定全局变量后显示 -->
		                  <div class="time"><?php echo $m.' '.$d.', '.$Y;?></div>
		                </div>
		                <h1><a href="single.html"><?php echo $item['e_name'];?></a></h1>
		                <p style="height:48px;overflow:hidden; text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical;">
		                	<?php echo $item['e_description'];?>
		                </p>
		                <footer>
		                	<!-- 判断数据库中某剧是否收藏 -->
